...
describe( "conf.adheresTo( spec )", () => {
  ...
  it( "reports false if even one setting is missing", () => {
  ...
  it( "reports false if there are any extra values", () => {
